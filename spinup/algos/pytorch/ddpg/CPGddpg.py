...
def ddpg(env_fn, actor_critic=CPGActorMLPCritic, ac_kwargs=dict(), seed=0,
    ...
    def test_agent():
        # TODO: decode and encode observations and actions
...
if __name__ == '__main__':
    ...
    ddpg(lambda: env_fn(active_joint_properties),
         actor_critic=CPGActorMLPCritic,
         ac_kwargs=dict(network=network,
                            v_names=v_names,
         ...
         steps_per_epoch=int(4.0/0.0025),
         logger_kwargs=logger_kwargs)